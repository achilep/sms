    ...
    <body ng-app="myApp" ng-controller="StudentFeeCtrl">
        ...
        <div class="container-scroller">
            ...
            <jsp:include page="/WEB-INF/views/partial/topnav.jsp"></jsp:include>
                ...
                <jsp:include page="/WEB-INF/views/partial/student/sidebar.jsp"></jsp:include>
                    <!-- partial -->
                                            ...
                                            <form:form commandName="paymentObject" action="paymentadd"
                                                ...
                                                <div class="form-group input-field col s6">
                                                    ...
                                                    <form:input id="name" class="form-control"
                                                                Placeholder="Payment Ammount" type="text" path="payammount" required="true"></form:input>
                                                    </div>
                                                    <div class="form-group input-field col s6">
                                                    <form:input id="name" class="form-control"
                                                                Placeholder="Payment Date" type="text" path="paydate" required="true"></form:input>
                                                    </div>
