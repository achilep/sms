...
public class AcademicyearCtrl {
    ...
    @RequestMapping("/showingacademicyearpage1")
    public ModelAndView showsubjectpage1() {
        String subgsonlist = sub.viewAcademicyear();
        ModelAndView mv = new ModelAndView("student/academicyear", "addAcademicyearObject1", new Academicyear());
        mv.addObject("academicyearmodelobject", subgsonlist);
        mv.addObject("check", "true");
        return mv;
    }
